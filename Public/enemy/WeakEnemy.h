...
// 敵固有の行動と戦闘を処理する役割を持つ。
UCLASS()
class PJ26_API AWeakEnemy : public AEnemyOrigin
{
	GENERATED_BODY()
...
public:
	...
	void OnWeaponOverlapsBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
...
private:
	...
	FName TraceStartSocket = TEXT("FX_Trail_01_R");

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Trace", meta = (AllowPrivateAccess = "true"))
	FName TraceEndSocket = TEXT("FX_Trail_02_R");
